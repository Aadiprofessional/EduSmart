export const zhCN = {
  ...
  aiStudy: {
    ...
    aiTimetableImportDescription: "上传你的时间表图片，让 AI 自动分析并生成带优先级预测的学习任务。",
    uploadTimetableImage: "上传时间表图片",
    dragDropOrClickImage: "拖拽或点击选择图片文件",
    supportedImageFormats: "支持：JPG、PNG、GIF（最大 10MB）",
    uploadedFile: "已上传文件",
