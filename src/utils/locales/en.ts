export const en = {
  ...
  aiStudy: {
    ...
    aiTimetableImportDescription: "Upload your timetable image and let AI analyze it to automatically create study tasks with predicted priorities.",
    uploadTimetableImage: "Upload Timetable Image",
    dragDropOrClickImage: "Drag and drop or click to select an image file",
    supportedImageFormats: "Supports: JPG, PNG, GIF (Max 10MB)",
