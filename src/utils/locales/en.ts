export const en = {
  ...
  aiStudy: {
    ...
    aiImport: "AI Import",
    aiTimetableImport: "AI Timetable Import",
    aiStudyRoadmapGenerator: "AI Study Roadmap Generator",
    analyzeWithAI: "Analyze with AI",
    analyzing: "Analyzing...",
    aiImportProgressTitle: "AI import in progress",
    aiImportApproxTime: "3 mins",
    aiImportProgressStatus: "Estimated time left: {{seconds}}s",
    ...
    aiTimetableImportDescription: "Upload your timetable (image, PDF or DOCX) and let AI analyze it to automatically create study tasks with predicted priorities.",
    uploadTimetableImage: "Upload Timetable",
    dragDropOrClickImage: "Drag and drop or click to select a file",
    supportedImageFormats: "Supports: JPG, PNG, GIF, PDF, DOCX (Max 10MB)",
    uploadedFile: "Uploaded File",
    uploadedTimetableAlt: "Uploaded timetable",
    ...
    generateFirstRoadmapHint: "Generate your first AI roadmap to see it here.",
    untitledRoadmap: "Untitled Roadmap",
    generatePersonalizedStudyPlan: "Generate a personalized study plan based on your tasks",
    selectDateRange: "Select Date Range",
    start: "Start",
    end: "End",
    additionalContextOptional: "Additional Context (Optional)",
    additionalContextPlaceholder: "E.g., I want to focus more on Math this week, or I have an exam on Friday...",
    roadmapStrategyDescription: "Your personalized AI-generated study strategy",
    taskPriorities: "Task Priorities",
    timelineDistribution: "Timeline Distribution",
  ...
  methodSelection: {
    ...
    modalSubtitles: {
      ...
      speechToText: "Select the audio language for transcription",
  ...
  gradePage: {
    ...
    downloadFile: "Download File",
    studio: {
      badge: "AI Paper Grader",
      title: "Teacher Grading Studio",
      subtitle: "Upload answer-key docs and student sheets, then grade with AI.",
      loadingPaperGrader: "Loading paper grader...",
      pleaseSignIn: "Please sign in",
      signInPrompt: "Your paper grading workspace is secure. Sign in again to create folders, upload files, and run AI grading.",
      foldersTitle: "Folders",
      foldersSubtitle: "Create classes or exams, then manage their training docs.",
      searchFolders: "Search folders",
      folderNamePlaceholder: "Folder name (e.g. Math2025)",
      descriptionPlaceholder: "Description",
      createFolder: "Create Folder",
      loadingFolders: "Loading folders...",
      loadingWorkspace: "Loading folder workspace...",
      emptyFoldersTitle: "No folders yet",
      emptyFoldersSubtitle: "Create your first folder to start the paper grading workflow.",
      noDescription: "No description",
      noDescriptionProvided: "No description provided.",
      deleteFolder: "Delete Folder",
      selectFolderTitle: "Select a folder",
      selectFolderSubtitle: "Pick a folder on the left to manage KB docs, submissions, and graded reports.",
      stats: {
        folders: "Folders",
        docs: "KB Docs",
      ...
      tabs: {
        kbTitle: "Layer 1: KB Docs",
        kbSubtitle: "Upload answer keys and reference docs",
        submissionsTitle: "Layer 2: Submissions",
        submissionsSubtitle: "Upload student answer sheets"
      },
      kbTitle: "Knowledge Base Documents",
      kbSubtitle: "Allowed formats: PDF, DOCX, image. Maximum 5 docs per folder.",
      uploadKbDoc: "Upload KB Doc",
      emptyKbTitle: "No KB documents",
      emptyKbSubtitle: "Upload answer keys or model solutions so AI can grade with folder context.",
      ...
      emptySubmissionsSubtitle: "Upload student answer sheets in PDF or DOCX to start grading.",
      totalMarks: "Total Marks",
      gradeCoinsButton: "Grade (10 coins)",
      viewReport: "View Report",
      selectResultTitle: "Select a result",
      selectResultSubtitle: "Choose a result to review AI feedback and question-wise details.",
      reportModal: {
        title: "Student Report"
      },
      previewModal: {
        kbPreviewTitle: "KB Document Preview",
        submissionPreviewTitle: "Submission Preview",
        openOriginal: "Open Original",
        unsupported: "Preview is not available for this file type. Use Open Original to view it."
      },
      uploadModal: {
        title: "Upload Student Answer Sheet",
        subtitle: "Add student name and choose a file to upload.",
        studentNamePlaceholder: "Student name",
        selectFile: "Select PDF or DOCX file",
        browse: "Browse",
        formats: "Accepted formats: PDF, DOC, DOCX",
        submit: "Upload Submission"
      },
      coinCostLabel: "Per Grade",
      coinCostValue: "10 Coins",
      coinsAlt: "Coins",
      justNow: "Just now",
      thisFolder: "this folder",
      messages: {
        folderCreated: "Folder created successfully.",
        deleteFolderConfirm: "Delete {{name}}? This removes all docs, submissions, and results.",
        folderDeleted: "Folder deleted.",
        selectFolderFirst: "Select a folder first.",
        maxDocsReached: "Maximum 5 KB docs are allowed per folder.",
        kbUploaded: "KB document uploaded. Processing started.",
        deleteDocConfirm: "Delete this KB document?",
        docDeleted: "Document deleted.",
        studentNameRequired: "Student name is required before uploading answer sheets.",
        submissionUploaded: "Student answer sheet uploaded.",
        deleteSubmissionConfirm: "Delete this submission and result?",
        submissionDeleted: "Submission deleted.",
        totalMarksPositive: "Total marks should be a positive number.",
        gradingCompleted: "Grading completed. 10 coins deducted.",
        deleteResultConfirm: "Delete this result? Submission will return to ready state.",
        resultDeleted: "Result deleted. Submission reset to ready.",
        previewUnavailable: "Preview not available for this file.",
        noReportYet: "No report available yet for this student.",
