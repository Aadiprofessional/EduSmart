export const zhTW = {
  ...
  auth: {
    login: {
      title: "歡迎回來",
      subtitle: "登入您的帳戶繼續學習之旅",
      welcomeBackToMatrixEdu: "歡迎回到MatrixEdu",
      continueJourney: "繼續您在MatrixEdu AI驅動平台上的學習之旅",
      yourAiPoweredCompanion: "您的AI驅動學習伴侶",
      unlockPotential: "用AI驅動的學習體驗釋放您的潛力",
      emailLabel: "電子郵件",
      passwordLabel: "密碼",
    ...
    signup: {
      title: "建立您的帳戶",
      subtitle: "加入數千名正在用AI改變教育的學生",
      joinMatrixEduToday: "今天加入MatrixEdu",
      startAiJourney: "在MatrixEdu開始您的AI驅動學習之旅",
      transformFuture: "用AI教育改變您的未來",
      joinThousandsLearners: "加入數千名正在用AI驅動教育改變未來的學習者",
      nameLabel: "全名",
      emailLabel: "電子郵件",
      passwordLabel: "密碼",
      ...
      signUpError: "建立帳戶失敗，請重試。",
      orSignUpWith: "或使用以下方式註冊",
      creatingAccount: "正在建立帳戶...",
      socialSignupError: "註冊失敗。請重試。",
      // Feature descriptions for signup page
      features: {
        joinStudents: {
          title: "加入50K+學生",
          description: "與全球社群一起學習"
        },
        securePrivate: {
          title: "安全私密",
          description: "您的資料受到保護"
        },
        aiPoweredPaths: {
          title: "AI驅動路徑",
          description: "個人化學習之旅"
        ...
        fastTrackSuccess: {
          title: "快速通道成功",
          description: "加速您的職業發展"
        }
      },
      mobileFeatures: {
        freeCertificate: "免費證書",
        lifetimeAccess: "終身存取",
  ...
  home: {
    title: '歡迎來到MatrixEdu',
    subtitle: '使用AI驅動的工具革新您的學習體驗',
    hero: {
      title: "MatrixEdu",
      subtitle: "透過AI驅動的個人化學習、專家輔導和全面的留學支援，賦能學生。您的學術卓越之旅從這裡開始。",
      startLearning: "開始學習",
      aboutUs: "關於我們",
      active: "啟動",
      poweredBy: "MatrixEdu AI 提供技術支援",
      ...
      features: {
        aiPoweredLearning: {
          title: "AI驅動學習",
          description: "透過先進機器學習演算法提供個人化輔導"
        },
        studyAbroadSupport: {
          title: "留學支援", 
          description: "全球大學配對和申請指導"
        },
        documentAnalysis: {
          title: "文件分析",
          description: "AI驅動的文件摘要和分析工具"
        },
        expertMentorship: {
          title: "專家指導",
          description: "與經驗豐富的教育者和職業顧問聯繫"
        }
      },
      ...
      sliderFeatures: {
        documentSummarizer: {
          title: "AI文件摘要器",
          description: "上傳和分析文件，AI驅動的摘要和洞察",
          buttonText: "試用文件分析器",
          preview: "上傳PDF、圖片或文字檔案進行即時AI分析"
        },
        databaseAnalysis: {
          title: "AI資料庫分析", 
          description: "全面的學生檔案分析用於大學配對",
          buttonText: "分析檔案",
          preview: "基於學術實力和大學推薦的AI驅動洞察"
        },
        studyPlanner: {
          title: "智能學習規劃器",
          description: "AI驅動的學習排程與個人化推薦", 
          buttonText: "規劃您的學習",
          preview: "使用AI路線圖生成創建智能學習計劃"
        },
        contentWriter: {
          title: "AI內容編寫器",
          description: "使用AI生成論文、研究論文和學術內容",
          buttonText: "開始寫作",
          preview: "提供多種範本的專業學術寫作輔助"
        },
        aiTutor: {
          title: "AI導師聊天",
          description: "獲得作業和學術問題的即時幫助",
          buttonText: "與AI導師聊天", 
          preview: "全天候AI輔導支援，涵蓋所有學科和主題"
        }
      },

      // Stats
      stats: {
        studentsHelped: "幫助的學生",
        successRate: "成功率",
        universities: "大學", 
        aiSupport: "AI支援"
      }
    ...
    featuredCourses: {
      title: "精選課程",
      subtitle: "發現我們最受歡迎的AI驅動課程，旨在加速您的學習之旅",
      loadingCourses: "載入課程中...",
      errorLoading: "載入課程時出錯",
      featured: "精選",
      instructor: "講師",
      price: "價格",
      students: "學生",
      enrollNow: "立即報名",
      enroll: "報名",
      viewAllCourses: "查看所有課程"
    },
    featuredScholarships: {
      title: "獎學金機會",
      subtitle: "透過我們旨在支援學術卓越和創新的綜合獎學金項目釋放您的潛力",
      loadingScholarships: "載入獎學金機會中...",
      errorLoading: "無法載入獎學金",
      showingSampleText: "顯示範例獎學金",
      readyToLaunch: "準備好啟動您的未來嗎？",
      launchDescription: "不要讓經濟障礙阻礙您。探索我們全面的獎學金資料庫，為您的學術之旅找到完美的機會。",
      exploreScholarships: "探索所有獎學金",
      applyNow: "立即申請",
      apply: "申請",
      ...
      sampleScholarships: {
        meritBased: {
          title: "優秀獎學金",
          description: "基於傑出學術成就和領導潛力授予的獎學金。",
          recipients: "學生"
        },
        globalOpportunities: {
          title: "全球機會", 
          description: "為追求卓越的國際學生設計的特殊資助機會。",
          recipients: "學生"
        },
        needBased: {
          title: "需求型支援",
          description: "基於證明需求和學術承諾的經濟援助。",
          recipients: "學生"
        }
      }
    },
    featuredSuccessStories: {
      title: "成功故事",
      subtitle: "來自透過MatrixEdu改變學術之旅的學生的真實故事",
      loadingStories: "載入成功故事中...",
      errorLoading: "載入成功故事時出錯",
      readStory: "閱讀故事",
      ...
      sampleStories: {
        sarah: {
          name: "Sarah Chen",
          achievement: "被MIT錄取",
          story: "MatrixEdu的AI輔導幫助我掌握了微積分和物理，最終被MIT電腦科學專業錄取。",
          university: "MIT",
          course: "電腦科學"
        },
        marcus: {
          name: "Marcus Johnson", 
          achievement: "全額獎學金獲得者",
          story: "獎學金指導和論文優化工具幫助我獲得了史丹佛大學的全額獎學金。",
          university: "Stanford",
          course: "工程學"
        },
        emily: {
          ...
          achievement: "職業轉型", 
          story: "透過MatrixEdu的綜合課程和指導項目，從市場行銷轉向資料科學。",
          course: "資料科學"
        }
      }
    },
    featuredResources: {
      title: "精選資源",
      subtitle: "存取我們全面的指南、範本和教育材料集合",
      loadingResources: "正在載入資源...",
      errorLoading: "載入資源時出錯",
      showingSampleText: "顯示範例資源資料",
      downloadNow: "立即下載",
      download: "下載",
      get: "獲取",
      free: "免費",
      featured: "精選",
      viewAllResources: "檢視所有資源",
    ...
    impact: {
      title: "我們的影響",
      subtitle: "透過創新的AI驅動解決方案在全球範圍內改變教育",
      studentsEnrolled: "註冊學生",
      coursesAvailable: "可用課程",
      successRate: "成功率",
      aiSupport: "AI支援"
    },
    transform: {
      title: "準備轉變？",
      subtitle: "加入已經透過MatrixEdu的AI驅動平台加速學習的數千名學生。",
      startJourney: "開始您的旅程",
      start: "開始",
  ...
  gradePage: {
    ...
    studio: {
      badge: "AI 試卷批改",
      title: "教師批改工作台",
      subtitle: "上傳參考答案與學生作答，再由 AI 進行批改。",
      loadingPaperGrader: "正在載入試卷批改...",
      pleaseSignIn: "請先登入",
      signInPrompt: "你的批改工作區受保護。請重新登入後建立資料夾、上傳檔案並啟動 AI 批改。",
      foldersTitle: "資料夾",
      foldersSubtitle: "先建立班級或考試，再管理訓練文件。",
      searchFolders: "搜尋資料夾",
      folderNamePlaceholder: "資料夾名稱（例如 Math2025）",
      descriptionPlaceholder: "描述",
      createFolder: "建立資料夾",
      loadingFolders: "正在載入資料夾...",
      loadingWorkspace: "正在載入工作區...",
      emptyFoldersTitle: "尚無資料夾",
      emptyFoldersSubtitle: "建立第一個資料夾以開始試卷批改流程。",
      noDescription: "無描述",
      noDescriptionProvided: "尚未提供描述。",
      deleteFolder: "刪除資料夾",
      selectFolderTitle: "請選擇資料夾",
      selectFolderSubtitle: "在左側選擇資料夾，以管理知識庫文件、提交與報告。",
      stats: {
        folders: "資料夾",
        docs: "知識庫文件",
        submissions: "提交",
      ...
      tabs: {
        kbTitle: "第 1 層：知識庫文件",
        kbSubtitle: "上傳答案與參考文件",
        submissionsTitle: "第 2 層：學生提交",
        submissionsSubtitle: "上傳學生作答檔"
      },
      kbTitle: "知識庫文件",
      kbSubtitle: "支援格式：PDF、DOCX、圖片。每個資料夾最多 5 份文件。",
      uploadKbDoc: "上傳知識庫文件",
      emptyKbTitle: "尚無知識庫文件",
      emptyKbSubtitle: "上傳標準答案或範例作答，讓 AI 依情境批改。",
      uploadedAt: "上傳於 {{date}}",
      status: "狀態",
      previewUnavailable: "無法預覽",
      searchSubmissions: "搜尋提交",
      uploadAnswerSheet: "上傳答題紙",
      emptySubmissionsTitle: "尚無提交",
      emptySubmissionsSubtitle: "上傳 PDF 或 DOCX 學生答題紙後即可開始批改。",
      totalMarks: "總分",
      gradeCoinsButton: "批改（10 點數）",
      viewReport: "查看報告",
      selectResultTitle: "請選擇報告",
      selectResultSubtitle: "選擇一筆結果以查看 AI 回饋與逐題明細。",
      reportModal: {
        title: "學生報告"
      },
      previewModal: {
        kbPreviewTitle: "知識庫文件預覽",
        submissionPreviewTitle: "提交檔案預覽",
        openOriginal: "開啟原始檔",
        unsupported: "此檔案類型暫不支援預覽，請點選「開啟原始檔」。"
      },
      uploadModal: {
        title: "上傳學生答題紙",
        subtitle: "輸入學生姓名並選擇檔案上傳。",
        studentNamePlaceholder: "學生姓名",
        selectFile: "選擇 PDF 或 DOCX 檔案",
        browse: "瀏覽",
        formats: "支援格式：PDF、DOC、DOCX",
        submit: "上傳提交"
      },
      coinCostLabel: "每次批改",
      coinCostValue: "10 點數",
      ...
      messages: {
        ...
        deleteFolderConfirm: "刪除 {{name}}？這會移除所有文件、提交與結果。",
        folderDeleted: "資料夾已刪除。",
        selectFolderFirst: "請先選擇資料夾。",
        maxDocsReached: "每個資料夾最多只能有 5 份知識庫文件。",
        kbUploaded: "知識庫文件已上傳，處理中。",
        deleteDocConfirm: "要刪除此知識庫文件嗎？",
        docDeleted: "文件已刪除。",
        studentNameRequired: "上傳答題紙前必須填寫學生姓名。",
        submissionUploaded: "學生答題紙已上傳。",
        deleteSubmissionConfirm: "刪除此提交與其結果嗎？",
        submissionDeleted: "提交已刪除。",
        totalMarksPositive: "總分必須為正數。",
        gradingCompleted: "批改完成，已扣除 10 點數。",
        deleteResultConfirm: "刪除此結果？提交將回到可批改狀態。",
        resultDeleted: "結果已刪除，提交已重設為可批改。",
        previewUnavailable: "此檔案無法預覽。",
        noReportYet: "此學生目前尚無報告。",
  ...
  aiStudy: {
    ...
    aiImport: "AI導入",
    aiTimetableImport: "AI時間表導入",
    aiStudyRoadmapGenerator: "AI學習路線圖生成器",
    analyzeWithAI: "AI分析",
    analyzing: "分析中...",
    aiImportProgressTitle: "AI 匯入進行中",
    aiImportApproxTime: "約 3 分鐘",
    aiImportProgressStatus: "預計剩餘時間：{{seconds}} 秒",
    aiRoadmap: "AI路線圖",
    aiStudyRoadmap: "AI學習路線圖",
    ...
    aiTimetableImportDescription: "上傳你的時間表（圖片、PDF 或 DOCX），讓 AI 自動分析並建立附帶預測優先級的學習任務。",
    uploadTimetableImage: "上傳時間表",
    dragDropOrClickImage: "拖放或點擊以選擇檔案",
    supportedImageFormats: "支援：JPG、PNG、GIF、PDF、DOCX（最大 10MB）",
    uploadedFile: "已上傳檔案",
    uploadedTimetableAlt: "已上傳的時間表",
    textExtractedSuccessfully: "文字擷取成功",
    aiAnalysisResults: "AI 分析結果",
    close: "關閉",
    general: "一般",
    addTasks: "新增 {{count}} 項任務",
    roadmapHistory: "路線圖歷史",
    generateFirstRoadmapHint: "先生成你的第一個 AI 路線圖，它會顯示在這裡。",
    untitledRoadmap: "未命名路線圖",
    generatePersonalizedStudyPlan: "根據你的任務生成個人化學習計畫",
    selectDateRange: "選擇日期範圍",
    start: "開始",
    end: "結束",
    additionalContextOptional: "補充內容（可選）",
    additionalContextPlaceholder: "例如：我這週想更專注在數學，或是我週五有考試……",
    roadmapStrategyDescription: "你的個人化 AI 學習策略",
    taskPriorities: "任務優先級",
    timelineDistribution: "時間軸分佈",
    ...
    setReminder: "設定提醒",
    removeReminder: "移除提醒",
    currentReminder: "目前提醒",
    atTime: "於",
    reminderDateLabel: "提醒日期",
    reminderTimeLabel: "提醒時間",
    generatingRoadmap: "正在生成路線圖...",
    generateStudyRoadmap: "生成學習路線圖",
