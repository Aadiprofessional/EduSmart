export const zhTW = {
  ...
  aiStudy: {
    ...
    aiTimetableImportDescription: "上傳你的時間表圖片，讓 AI 自動分析並建立附帶預測優先級的學習任務。",
    uploadTimetableImage: "上傳時間表圖片",
    dragDropOrClickImage: "拖放或點擊以選擇圖片檔案",
    supportedImageFormats: "支援：JPG、PNG、GIF（最大 10MB）",
    uploadedFile: "已上傳檔案",
