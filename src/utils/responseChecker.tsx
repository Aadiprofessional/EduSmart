    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-slate-800 rounded-2xl border border-white/10 p-6 max-w-md w-full">
        <div className="text-center">
          <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-gradient-to-r from-indigo-500 to-red-500 hover:from-indigo-600 hover:to-red-600 text-white rounded-lg transition-all"
            >
              Upgrade Now
            </button>
          </div>
