  ...
  const upcomingFeatures = [
    {
      ...
      release: 'Coming Soon',
      icon: <IconComponent icon={FaRobot} className="text-indigo-500 text-5xl" />,
    ...
    },
    {
      ...
      icon: <IconComponent icon={FaUsers} className="text-indigo-500 text-5xl" />,
    ...
    },
    {
      ...
      icon: <IconComponent icon={FaUniversity} className="text-indigo-500 text-5xl" />,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {upcomingFeatures.slice(0, 6).map((feature, index) => (
            <AnimatedSection key={feature.id} direction="up" delay={0.1 * index}>
              ...
              >
                <motion.div 
                  className="absolute top-4 right-4 bg-indigo-500 text-white text-xs py-1 px-2 rounded z-10"
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center text-gray-600 mb-1">
                    <IconComponent icon={FaCalendarAlt} className="mr-2 text-indigo-500" />
              ...
              >
                <motion.div 
                  className="absolute top-2 right-2 bg-indigo-500 text-white text-xs py-1 px-2 rounded z-10"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                >
                  NEW
                ...
                <div className="p-4 w-3/5">
                  ...
                  <div className="flex items-center text-gray-600 mb-1">
                    <IconComponent icon={FaCalendarAlt} className="mr-1 text-indigo-500 text-xs" />
                  ...
                  >
                    <Link 
                      to={feature.link}
                      className="text-indigo-500 hover:text-indigo-600 font-medium inline-flex items-center text-sm"
                    >
                      Learn More 
                      <motion.span 
                        initial={{ x: 0 }}
