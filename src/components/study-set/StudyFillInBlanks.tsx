...
const StudyFillInBlanks: React.FC = () => {
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center h-full max-w-4xl mx-auto w-full px-4">
            {/* Stats Pills */}
            <div className="flex flex-wrap justify-center gap-2 mb-12">
                <div className="bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-300 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-2">
                ...
                <div className="w-full max-w-md space-y-4">
                    {!showResult ? (
                        ...
                        <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-300">
                            ...
                            <button 
                                onClick={handleNext}
                                className="bg-gray-900 dark:bg-white text-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 px-8 py-3 rounded-lg font-bold transition-colors"
                            >
