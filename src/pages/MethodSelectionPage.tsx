                    ...
                    <div className="max-w-4xl w-full">
                        ...
                        <div className="flex justify-between items-center pt-6">
                            ...
                            <button 
                                ...
                                className={`bg-[#c2410c] hover:bg-[#9a3412] text-white px-12 py-3 rounded-lg font-bold transition-colors flex items-center gap-2 ${isGenerating ? 'opacity-70 cursor-wait' : ''}`}
                            >
